...
- **ESLint**: Flat config in `eslint.config.js` aligned to Next.js 16 + TypeScript
- **Prettier**: Config in `.prettierrc` (2-space indent, single quotes, semicolons, ES5 trailing commas, 100 character line width)
